...
//@author mrdoob / http://mrdoob.com/
    ...
    Behaviour.prototype = {
        ...
        applyBehaviour: function(particle, time, index) {
            ...
            if( typeof this.easing !== "function" ){
                console.error("Invalid easing in", this);
                debugger;
            }
            */
    ...
    Velocity.prototype.reset = function(a, b, c) {
        ...
        //[radius,vector,tha]
            ...
            b = b.clone();
            b.x = Proton.createSpan(b.x).getValue();
            b.y = Proton.createSpan(b.y).getValue();
            b.z = Proton.createSpan(b.z).getValue();
    ...
    Force.prototype.applyBehaviour = function(particle, time, index) {
        ...
        const add = new Vector3D();
        add.copy(this.force);
        add.scalar(1-this.energy);
        particle.a.add(add);
    };
     ...
     * @example new Proton.Rotate(Proton.createSpan(-1,1),true, true); - ADDitive, x decides speed
     * @example new Proton.Rotate(0, 1); - Rotate from 0 to 1 over the life
     * @example new Proton.Rotate(Proton.createSpan(-1,1)); - Set to this value on start
     * @example new Proton.Rotate(); - Follow velocity?
     */
    ...
    Rotate.prototype.initialize = function(particle) {
        ...
        switch (this._type) {
            ...
            case "set":
                this._setRotation(particle.rotation, new Proton.Vector3D(Proton.createSpan(this.a).getValue(), 0, 0));
                break;
            ...
            case "add":
                particle.transform.addR = new Proton.Vector3D(this.a.getValue(), 0,0);
                break;
        }
    };
    ...
    FollowEmitter.prototype.initEventHandler = function() {
        ...
        console.log("Adding eventListener proton");
    ...
    const easeToFullTime = function(value){
        if( value >= 0.5 )
    ...
    var ease = ease || {
        // Use with 0-1
        easeFullSine : function(value) {
            return ease.easeInOutSine(easeToFullTime(value));
        },
        // Use with 0-1
        easeFullBridge : function(value) {
            return ease.easeOutCirc(easeToFullTime(value));
        },
        // Eases to center, holds there, then eases the rest
        easeFullStairStep : function(value){
            if( value < 0.5 ){
                value *= 2;
                return ease.easeOutCirc(value)/2;
            }
            value = (value-0.5)*2;
            return ease.easeInCirc(value)/2+0.5;
        },
    ...
    MeshRender.prototype.onParticleCreated = function(particle) {
        ...
        if (particle.target) {
            ...
            const targ = particle.parent.mesh || this.container;
            targ.add(particle.target);
        }

        this.isSpriteRender = this.name === 'SpriteRender';
